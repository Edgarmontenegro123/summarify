...
export const translations: Record<SummaryLanguage, Translations> = {
  es: {
    ...
    "upload.readError": "Ocurrió un error al leer el PDF. Intenta con otro archivo.",
    ...
    "summarize.emptyResultError": "No se pudo generar el resumen. Intenta con otro texto.",
  ...
  en: {
    ...
    "upload.readError": "Something went wrong reading the PDF. Try another file.",
    ...
    "summarize.emptyResultError": "Couldn't generate the summary. Try a different text.",
